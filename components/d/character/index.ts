...
export const DCharacter = Character
export const DCharacterShapeIdle = ShapeIdle
export const DCharacterShapeAction = ShapeAction
export const DCharacterShapeProfi = ShapeProfi
